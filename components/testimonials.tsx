  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-5 sm:px-6 md:px-8 relative z-10">
        ...
        >
          <h2 id="testimonials-heading" className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">Kundomdömen</h2>
          <p className="text-base sm:text-lg text-white/70 max-w-2xl mx-auto">
            Ta en sekund och lyssna på vad våra tidigare kunder tycker om vårt arbete.
          </p>
        </motion.div>
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div 
            className="min-h-[300px] sm:min-h-[400px] flex items-center"
            role="region" 
