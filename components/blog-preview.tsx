...
export default function BlogPreview() {
  const articles = [
    {
      title: "10 tips för att sälja din fastighet snabbare",
      excerpt: "Upptäck hur professionell fotografering och videoproduktion kan hjälpa dig att sälja ditt objekt snabbare och till bättre pris.",
    ...
    {
      title: "Varför drönarfilmning är viktigt för fastighetsförsäljning",
      excerpt: "Se hur drönarfilmning kan visa ditt objekts omgivningar och ge potentiella köpare en bättre helhetsbild.",
    ...
    {
      title: "Virtuell inredning - hjälp köpare att visualisera",
      excerpt: "Lär dig hur virtuell inredning kan hjälpa potentiella köpare att se möjligheterna i tomma rum och öka intresset.",
  ...
  return (
    <section className="py-5 sm:py-20 md:py-24 bg-black relative overflow-hidden" aria-labelledby="blog-heading">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div>
            <h2 id="blog-heading" className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3">Tips & råd</h2>
            <p className="text-base sm:text-lg text-white/70 max-w-2xl">
              Expertråd om fastighetsfotografering och försäljning
            </p>
          </div>
