  ...
  const features = [
    {
      ...
      benefits: [
        ...
        "1 skymningsbild",
        "1 planritning",
        "För lägenheter: 1 rum och alla övriga utrymmen ingår. För villor: 2 rum och alla övriga utrymmen ingår",
        "Priser: Lägenheter 1400 kr, Villor 2600 kr",
        "Kombinerat paket (Fotografi + Video): Lägenheter 2700 kr, Villor 4000 kr",
      ],
      image: "/foto.webp",
    },
    {
      ...
      description:
        "Exposia erbjuder professionell bostadsvideo i Stockholm och fastighetsfilm som presenterar bostaden med drönarvideo, gimbal-stabiliserad inomhusfilmning och korta klipp optimerade för sociala medier. Vi planerar storyboard, filmar höjd- och detaljvyer och levererar färdiga videor som ger spekulanter en tydlig känsla för bostaden innan visning.",
      benefits: [
        "30–45 sekunders video (horisontell eller vertikal) redo för Hemnet och sociala medier",
        "Drönarvideo inkluderad för exteriöra vyer",
        "Stabiliserad walkthrough inomhus med fokus på flöde och planlösning",
        "Text/graphics overlays för viktiga highlights kan läggas till på begäran",
        "Priser: Lägenheter 2200 kr, Villor 3200 kr",
        "Kombinerat paket (Fotografi + Video): Lägenheter 2700 kr, Villor 4000 kr",
      ],
      image: "/video.jpg",
    },
    {
      ...
      description:
        "Ytterligare tjänster för att förbättra presentationen av din fastighet och öka intresset från potentiella köpare. Vi erbjuder extra rum, 3D-planritning, säsongsbyte av fastighetsbilder och fastighetsvideor med mäklarpresentation för optimal fastighetsmarknadsföring. Exposia hjälper dig att skapa en komplett marknadsföringspaket som visar din fastighet från alla vinklar och ökar chanserna för en snabb försäljning i Stockholm. Våra extratjänster kompletterar vårt huvudpaket med fastighetsfotografi och bostadsvideo för att ge dig den bästa möjliga presentationen av ditt objekt.",
      benefits: [
        "Extra rum – För lägenheter ingår 1 rum, för villor 2 rum. Extra rum kan läggas till (300 kr per rum)",
        "3D-planritning och 3D-walkthrough (+450 kr) för ökad tydlighet",
        "Virtuella visningar/VR-turer för fjärrspekulanter",
        "Ytterligare drönarstillbilder och drönarsekvenser (70 kr per bild/sekvens)",
        "Foto med säsongsbyte – digital omvandling av bilder för olika årstider (+250 kr)",
        "Videor med mäklarpresentation eller speaker (+550 kr)",
        "Stylingråd och enklare objektfix inför fotografering",
      ],
      image: "/twilight.jpg",
    },
  ]
