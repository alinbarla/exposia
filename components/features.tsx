  ...
  const features = [
    ...
    },
    {
      ...
      benefits: [
        ...
        "3D-planritning (+450 kr)",
        "Foto med säsongsbyte - Digital omvandling av bilder för att visa bostaden under olika årstider (+250 kr)",
        "Videor av fastighet med mäklarpresentation (+550 kr)",
